    ...
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
            <div class="body bg-teal">
                <div class="font-bold m-b--35"><h3 style="font-family: 'Rubik', sans-serif; "><?php echo $category->name; ?></h3></div>
                <ul class="dashboard-stat-list">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($product->category_id == $category->id): ?>
                            <?php if(!empty($product)): ?>
                            <li style="font-family: 'Rubik', sans-serif; ">
                                <h4 style="font-family: 'Rubik', sans-serif; "><?php echo e($product->name); ?></h4>
                                <h5 style="font-family: 'Rubik', sans-serif; "><?php echo e($lang['description']); ?>:<?php echo $product->description; ?></h5>
                            </li>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php /**PATH D:\food-shop\views/panel/home/home-buyer.blade.php ENDPATH**/ ?>