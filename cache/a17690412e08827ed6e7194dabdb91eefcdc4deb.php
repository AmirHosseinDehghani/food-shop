                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tr>
                                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td>
                                                <a
                                                        href="/buyer/delete-order/<?php echo e($order->id); ?>"
                                                        class="btn btn-danger">
                                                    <?php echo e($lang['delete']); ?> <span class="fa fa-trash"></span>
                                                </a>
                                            </td>
                                            <td>
                                                <a
                                                        href="/buyer/print-order/<?php echo e($order->id); ?>" class="btn btn-info">
                                    ...
                                    <?php if(isset($price)): ?>
                                        <tr>
                                            ...
                                            <th>
                                                <?php echo e($lang['success']); ?>

                                            </th>
                                            <td>
                                                <a
                                                        href="/buyer/pay-form" class="btn btn-success">
                                                    <span class="fa fa-trash"><?php echo e($lang['success']); ?></span>
                                                </a>
                                            </td>
                                            <th>
                                                <img style="width: 50px" src="\public\image\logo.png">
...
</html><?php /**PATH D:\food-shop\views//panel/orders/order-buyer.blade.php ENDPATH**/ ?>