                ...
                <div class="body">
                    <div>
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation"><a id="list_of_products_id" href="#list_of_products" aria-controls="settings"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in" id="list_of_products">
                                ...
                                <?php endif; ?>
                                <div class="search-icon">
                                    <input class="input" type="text" id="gfg" placeholder="search for name ">
                                </div>
                                    ...
                                    <table id="myTable"
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e($lang['image']); ?></th>
                                            <th><?php echo e($lang['seller']); ?></th>
                                            ...
                                            <?php if(!empty($products)): ?>
                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a
                                                                href="/buyer/add-to-oder/<?php echo e($product->id); ?>"
                                                                class="btn btn-success">
                                                            add to order <span class="fa fa-trash"></span>
                                                        </a>
                                                    </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH D:\food-shop\views/panel/product/product-buyer.blade.php ENDPATH**/ ?>