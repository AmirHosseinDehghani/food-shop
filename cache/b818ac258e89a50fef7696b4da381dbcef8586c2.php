        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true"
                         aria-expanded="false"> <h2>hello admin</h2></div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo e('/logout'); ?>"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo e('/home-admin'); ?>">
                            <i class="material-icons">home</i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e('/admin/user-setting'); ?>">
                            <i class="material-icons">group</i>
                            <span>Users setting</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e('/admin/product-setting'); ?>">
                            <i class="material-icons">shopping_cart</i>
                            <span>products setting</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="<?php echo e('/admin/category-setting'); ?>">
...
<?php /**PATH D:\food-shop\views/panel/menus/menu-admin.blade.php ENDPATH**/ ?>