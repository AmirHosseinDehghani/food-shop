                    ...
                    <div>
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a id="profile_settings" href="#profile" aria-controls="settings"
                                                       role="tab"
                                                       data-toggle="tab" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['title_setting']); ?></a></li>
                            <li role="presentation"><a id="change_password_settings" href="#change_password"
                                                       aria-controls="settings"
                                                       role="tab" data-toggle="tab" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['change_password']); ?></a>
                            </li>
                            <li role="presentation"><a id="upload_profile_id" href="#upload_profile"
                                                       aria-controls="settings" role="tab"
                                                       data-toggle="tab" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['upload_profile']); ?></a></li>
                            <li role="presentation"><a href="#profile_image_setting" aria-controls="settings" role="tab"
                                                       data-toggle="tab" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['profile_image_setting']); ?></a></li>
                        </ul>

                        <div class="tab-content">

                            <div role="tabpanel" class="tab-pane fade in" id="profile">
                                <?php if(isset($_SESSION['profile-edit'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-info     text-center"><?php echo e($_SESSION['profile-edit']); ?></div>
                                    <?php unset($_SESSION['profile-edit']); ?>
                                <?php endif; ?>
                                <form method="post" action="<?php echo e('/edit-profile'); ?>" class="form-horizontal">
                                    <div class="form-group">
                                        <label for="NameSurname"
                                               class="col-sm-2 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['name']); ?></label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                                <input style="font-family: 'Rubik', sans-serif;" type="text" class="form-control" id="NameSurname" name="name"
                                                       ...
                                                       value="<?php echo e($_SESSION['user']->name); ?>"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="Email" class="col-sm-2 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['email']); ?></label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                                <input style="font-family: 'Rubik', sans-serif;" type="email" class="form-control" id="Email" name="email"
                                                       placeholder="<?php echo e($lang['email']); ?>"
                                                       value="<?php echo e($_SESSION['user']->email); ?>"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-danger" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['submit']); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div role="tabpanel" class="tab-pane fade in" id="change_password">
                                <?php if(isset($_SESSION['profile-password-success'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-info text-center"><?php echo e($_SESSION['profile-password-success']); ?></div>
                                    <?php unset($_SESSION['profile-password-success']); ?>
                                <?php endif; ?>
                                <?php if(isset($_SESSION['profile-password-error'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-danger text-center"><?php echo e($_SESSION['profile-password-error']); ?></div>
                                    <?php unset($_SESSION['profile-password-error']); ?>
                                <?php endif; ?>
                                <form method="post" action="<?php echo e('/edit-password'); ?>" class="form-horizontal">
                                    <div class="form-group">
                                        <label for="OldPassword"
                                               class="col-sm-3 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['old_password']); ?></label>
                                        <div class="col-sm-9">
                                            <div class="form-line">
                                                <input style="font-family: 'Rubik', sans-serif;" type="password" class="form-control" id="old_password"
                                                       name="old_password" placeholder="<?php echo e($lang['old_password']); ?>"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="NewPassword"
                                               class="col-sm-3 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['new_password']); ?></label>
                                        <div class="col-sm-9">
                                            <div class="form-line">
                                                <input style="font-family: 'Rubik', sans-serif;" type="password" class="form-control" id="password"
                                                       name="password" placeholder="<?php echo e($lang['new_password']); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="NewPasswordConfirm"
                                               class="col-sm-3 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['new_password_confirm']); ?></label>
                                        <div class="col-sm-9">
                                            <div class="form-line">
                                                <input style="font-family: 'Rubik', sans-serif;" type="password" class="form-control" id="PasswordConfirm"
                                                       name="PasswordConfirm"
                                                       placeholder="<?php echo e($lang['new_password_confirm']); ?>"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="upload_profile">
                                <?php if(isset($_SESSION['profile-icon-set'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-success text-center"><?php echo e($_SESSION['profile-icon-set']); ?></div>
                                    <?php unset($_SESSION['profile-icon-set']); ?>
                                <?php endif; ?>
                                <?php if(isset($_SESSION['profile-have-icon'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-warning text-center"><?php echo e($_SESSION['profile-have-icon']); ?></div>
                                    <?php unset($_SESSION['profile-have-icon']); ?>
                                <?php endif; ?>
                                <?php if(isset($_SESSION['profile-icon-error'])): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-danger text-center"><?php echo e($_SESSION['profile-icon-error']); ?></div>
                                    <?php unset($_SESSION['profile-icon-error']); ?>
                                <?php endif; ?>

                                    <form method="post" action="<?php echo e('/upload-profile'); ?>" enctype="multipart/form-data"
                                          class="form-horizontal">
                                        <?php if($_SESSION['user']->avatar == 'public/image/user.png'): ?>
                                        <div class="form-group">
                                            <label for="Profile"
                                                   class="col-sm-3 control-label" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['your_file']); ?></label>
                                            <div class="col-sm-9">
                                                <div class="form-line">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <button type="submit"
                                                        class="btn btn-danger" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['upload']); ?></button>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                    </form>
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="profile_image_setting">
                                <?php if(isset($profileDelete)): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-success text-center"><?php echo e($profileDelete); ?></div>
                                <?php endif; ?>
                                <?php if(isset($profileISEmpty)): ?>
                                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-danger text-center"><?php echo e($profileISEmpty); ?></div>
                                <?php endif; ?>
                                <table id="myTable"
                                    ...
                                    <thead>
                                    <tr>
                                        <th  style="font-family: 'Rubik', sans-serif;"  > <?php echo e($lang['your_profile']); ?></th>
                                        <th style="font-family: 'Rubik', sans-serif;" ><?php echo e($lang['type_image']); ?></th>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="/<?php echo e($_SESSION['user']->avatar); ?>">
                                                <img class="image" src="<?php echo e($_SESSION['user']->avatar); ?>" width="60"
                                                     height="60">
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <?php if($_SESSION['user']->avatar=='public/image/user.png'): ?>
                                                ...
                                                <?php echo e($lang['default_image']); ?>

                                            <?php else: ?>
                                                <?php echo e($lang['your_image']); ?>
...
<?php /**PATH D:\food-shop\views/panel/profile.blade.php ENDPATH**/ ?>