        ...
        <div class="body">
            ...
            <div>
                <?php if(isset($success)): ?>
                    <div style="font-family: 'Rubik', sans-serif;" class="alert alert-info text-center"><?php echo e($success); ?></div>
                <?php endif; ?>
            </div>
            <div>
                <?php if(isset($error)): ?>
                    <div style="font-family: 'Rubik', sans-serif " class="alert alert-info text-center"><?php echo e($error); ?></div>
                <?php endif; ?>
            </div>
            <form action="/login" id="sign_in" method="POST">
                ...
                <div class="row m-t-15 m-b--20">
                    <div class="col-xs-6">
                        <a href="<?php echo e('/signup-form'); ?>">ثبت نام</a>
                    </div>
                    <div class="col-xs-6 align-right">
                        <a href="<?php echo e('/forgot-password-form'); ?>">رمز خود را فراموش کردید؟</a>
                    </div>
                </div>
            </form>
        </div>
...
</html><?php /**PATH D:\food-shop\views/panel/useral/sign-in.blade.php ENDPATH**/ ?>