            ...
            <a href="/seller/product-seller-form">
                <div class="col-lg-6 col-md-4 col-sm-7 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['number_the_products']); ?>

                                : <?php echo e($productNumber); ?></div>
                            <div></div>
                        </div>
                    </div>
                </div>
            ...
            <a target="_blank" href="https://mail.google.com/">
                <div class="col-lg-6 col-md-4 col-sm-7 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text" style="font-family: 'Rubik', sans-serif;"><?php echo e($lang['check_email']); ?>

                                : <?php echo e($_SESSION['user']->email); ?></div>
                        </div>
                    </div>
                </div>
            </a>
...
<script>
    ...
    function drawChart() {
        const data = google.visualization.arrayToDataTable([
            ...
            ['Contry', 'جمع فروش'],
            ['پیتزا', <?php echo e($pizza); ?>],
            ['پاستا', <?php echo e($pasta); ?>],
            ['ساندویچ ایرانی', <?php echo e($iranian); ?>],
            ['برگر', <?php echo e($burger); ?>],
        ]);
