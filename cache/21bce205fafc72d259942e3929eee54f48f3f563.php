...
<div class="signup-box">
    <div class="logo">
        ...
        <small>Sign Up | welcome to food shop</small>
    </div>
        ...
        <div class="body">
            <form action="/signup" id="sign_up" method="POST">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="password" class="form-control" name="forget_key" minlength="6"
                               placeholder="write key to forget password" required>
                    </div>
                </div>
                <div class="input-group">
                        <span class="input-group-addon">
                ...
                <div class="m-t-25 m-b--5 align-center">
                    <a href="<?php echo e('/'); ?>">You already have a membership?</a>
                </div>
            </form>
        </div>
    </div>
...
</html><?php /**PATH D:\food-shop\views/panel/sign-up.blade.php ENDPATH**/ ?>