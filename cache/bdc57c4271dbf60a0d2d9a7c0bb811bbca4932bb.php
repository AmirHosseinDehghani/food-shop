...
<body style="font-size: 20 ; font-family: Vazir" class="theme-red">
<!-- Page Loader -->
    ...
    <div class="container-fluid">
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="card">
                <div class="body">
                    <div>
                        <div style="   text-align: center"> فروشنده <strong><?php echo e($_SESSION['seller']['id']); ?></strong></div>
                    ...
                    <div>
                        <div style="text-align: right"><?php echo e($_SESSION['order']['id']); ?> :شماره</div>
                        <div style="text-align: right"> تاریخ فاکتور: <?php echo e($_SESSION['order']['date']); ?> </div>
                        <div style="text-align: right"> شماره همراه/ثابت: <?php echo e($_SESSION['seller']['phone_number']); ?> </div>
                    </div>
                    <br>
                    <div>
                        ...
                        <table
                            ...
                            <tr>
                                <td style=" width: 50%;border: 1px solid  ; text-align: center"><?php echo $_SESSION['seller']["email"]; ?></td>
                                <td style=" border: 1px solid  ; text-align: center"><?php echo e($_SESSION['seller']["name"]); ?></td>
                    ...
                    <table
                        ...
                        <tr>
                            <td style=" border: 1px solid  ; text-align: center">
                                <?php if(empty($_SESSION['order']['number'])): ?>
                                    <?php echo e($_SESSION['lang']['Condition0']); ?>

                                <?php endif; ?>
                                <?php if($_SESSION['order']['number'] == 1): ?>
                                    <?php echo e($_SESSION['lang']['Condition1']); ?>

                                <?php endif; ?>
                                <?php if($_SESSION['order']['number'] == 2): ?>
                                    <?php echo e($_SESSION['lang']['Condition2']); ?>

                                <?php endif; ?>
                            </td>
                            <td style=" border: 1px solid  ; text-align: center"><?php echo e($_SESSION['order']['price']); ?></td>
                            <td style=" border: 1px solid  ; text-align: center"><?php echo e($_SESSION['order']['name']); ?></td>
                    ...
                    <table style=" border: 1px solid"
                        ...
                        <tr>
                            <th>
                                <div> مالیات 9%   = <?php echo e($_SESSION['index']); ?> +</div>
                                <div>حق فروش سایت 5% = <?php echo e($_SESSION['index1']); ?> -</div>
                                <div>  مبلغ دریاقتی قروشنده با موارد بالا = <?php echo e($_SESSION['index2']); ?></div>
...
</html><?php /**PATH D:\food-shop\views//panel/orders/list.blade.php ENDPATH**/ ?>