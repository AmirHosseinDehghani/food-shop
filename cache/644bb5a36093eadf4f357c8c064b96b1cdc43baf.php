                ...
                <div class="body">
                    <div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel">
                                <?php if(isset($doc)): ?>
                                    <div class="alert alert-success text-center"><?php echo e($doc); ?><a>come back</a></div>
                                <?php endif; ?>
                                <form method="post" action="<?php echo e("/seller/product/edit/$id"); ?>" class="form-horizontal">
                                    <div class="form-group">
                                        <label for="NameSurname" class="col-sm-2 control-label">نام محصول</label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                                <input value="<?php echo e($product['name']); ?>" type="text" class="form-control"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="category_id" id="category_id">
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if($category->id ==$product['category_id']): ?> selected <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                                <input value="<?php echo e($product['price']); ?>" type="text" class="form-control"
...
<?php /**PATH D:\food-shop\views/panel/product/edit-product.blade.php ENDPATH**/ ?>