...
<div class="login-box">
    ...
    <div class="card">
        ...
        <div class="body">
            <div class="msg"> ایمیل خود را چک کنید . اگر در قسمت اصلی نبود در قسمت  اسپم آن را پیدا خواهید کرد . کد را کپی کنید و در این قسمت آن را بگزارید
            </div>
            <form action="/verify" id="sign_in" method="POST">
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="text" class="form-control" name="verify" placeholder="کد" required autofocus>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-4">
                        <button class="btn btn-block bg-pink waves-effect" type="submit">چک کردن کد</button>
                    </div>
                </div>
            </form>
        </div>
...
</html><?php /**PATH D:\food-shop\views/panel/useral/check.blade.php ENDPATH**/ ?>