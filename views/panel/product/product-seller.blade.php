                    ...
                    <div>
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a id="product_add_id" href="#product_list" aria-controls="settings"
                                                       role="tab"
                                                       data-toggle="tab">{{$lang['title3']}} </a></li>
                            <li role="presentation"><a id="product_list_id" href="#add" aria-controls="settings"
                                                       role="tab" data-toggle="tab">{{$lang['title2']}}</a></li>
                            <li role="presentation"><a id="sale_list_id" href="#sale" aria-controls="settings"
                                                       role="tab" data-toggle="tab">{{$lang['title4']}}</a></li>
                        </ul>

                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in" id="product_list">

                                @if(isset($_SESSION['productTypeError']))
                                    <div class="alert alert-danger text-center">{{$_SESSION['productTypeError']}}</div>
                                    @unset($_SESSION['productTypeError'])
                                @endif
                                <form method="post" action="{{'/add-product'}}" class="form-horizontal"
                                      enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="NameSurname"
                                               class="col-sm-2 control-label">{{$lang['name']}}</label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <label for="NameSurname"
                                               class="col-sm-2 control-label">{{$lang['price']}}</label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <label for="NameSurname"
                                               class="col-sm-2 control-label">{{$lang['icon']}} </label>
                                        <div class="col-sm-10">
                                            <div class="form-line">
                                    ...
                                    <div class="form-group">
                                        <label for="Email"
                                               class="col-sm-2 control-label">{{$lang['description']}}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-success col-sm-2  ">{{$lang['submit']}}</button>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tr>
                                            @foreach($sales as $sale)
                                                ...
                                                <td>
                                                    <a href="/seller/product/print/{{$sale->id}}"
                                                       style="color:white"
                                                       class="btn btn-info">{{$lang['print']}}</a>
                                                </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
                            ...
                            <div class="tab-pane fade in" id="add">
                                @if(isset($_SESSION['doc']))
                                    <div class="alert alert-info text-center">{{$_SESSION['doc']}}</div>
                                    @unset($_SESSION['doc'])
                                @endif
                                    ...
                                    <tr>
                                        @foreach($products as $product)
                                            ...
                                            <td>
                                                ...
                                                <a href="/seller/product/edit-form/{{$product->id}}"
