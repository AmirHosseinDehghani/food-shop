                    ...
                    <div>
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation"><a href="#change_password_settings" aria-controls="settings"
                                                       role="tab" data-toggle="tab">list of products</a></li>
                        </ul>
                                        ...
                                        @foreach($products as $product)
                                            ...
                                            <td>
                                                <a onclick="return confirm('ایا از حذف دسته بندی مطمئن هستید؟')"
                                                   href="/product/delete/{{$product->id}}" class="btn btn-danger">
                                                    delete <span class="fa fa-trash"></span>
                                                </a>
                                                <a href="user/invisible/{{$product->id}}" class="btn btn-success">
                                                    invisible</a>
                                            </td>
                                    </tr>
                                    @endforeach
