    ...
    @foreach($categories as $category)
        <div class="card">
            <div class="body bg-teal">
                <div class="font-bold m-b--35"><h3 style="font-family: 'Rubik', sans-serif; ">{!!  $category->name!!}</h3></div>
                <ul class="dashboard-stat-list">
                    @foreach($products as $product)
                        @if($product->category_id == $category->id)
                            @if(!empty($product))
                            <li style="font-family: 'Rubik', sans-serif; ">
                                <h4 style="font-family: 'Rubik', sans-serif; ">{{$product->name}}</h4>
                                <h5 style="font-family: 'Rubik', sans-serif; ">{{$lang['description']}}:{!!$product->description!!}</h5>
                            </li>
                            @endif
                        @endif
                    @endforeach
